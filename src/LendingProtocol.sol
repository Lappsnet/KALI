    ...
    // SafeMath is no longer needed in Solidity 0.8.0+
    ...
    contract LendingProtocol is ReentrancyGuard {
        // SafeMath is no longer needed as Solidity 0.8.0+ has built-in overflow checking
            ...
            nonReentrant 
        {
            ...
            try propertyToken.safeTransferFrom(loan.borrower, address(this), loan.propertyId) {
                // Update loan status
