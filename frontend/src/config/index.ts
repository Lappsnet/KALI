import { http, parseGwei, parseGwei } from 'viem';
...
export const pharos = defineChain({
  ...
  name: 'Pharos Network',
  nativeCurrency: { decimals: 18, name: 'Pharos', symbol: 'ETH' }, // Verify symbol
  ...
  contracts: {
    ...
    marketplaceOrchestrator: { address: "0x43B69480Cf9308F10781fB3eEab20770c14ee73D" }, // Verify duplication
...
export const chains = [pharos, mainnet, sepolia];
...
export const wagmiAdapter = new WagmiAdapter({
  ...
  transports: {
    ...
    [mainnet.id]: http(mainnetBase.rpcUrls.default.http[0]),
    [sepolia.id]: http(sepoliaBase.rpcUrls.default.http[0]),
  }
});
...
export const CONTRACT_ADDRESSES = {
  [pharos.id]: {
    ...
    marketplaceOrchestrator: "0x43B69480Cf9308F10781fB3eEab20770c14ee73D" as `0x${string}`, // Verify duplication
  ...
  [mainnet.id]: { /* Add mainnet addresses if needed */ },
  [sepolia.id]: { /* Add sepolia addresses if needed */ },
};
